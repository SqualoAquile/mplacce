...
<link href="<?php echo BASE_URL?>/assets/css/fullcalendar.print.min.css" rel="stylesheet" type="text/css" media='print'/>
...
<script src="<?php echo BASE_URL?>/assets/js/vendor/fullcalendar.min.js" type="text/javascript"></script>
<script src="<?php echo BASE_URL?>/assets/js/vendor/locale-all.js" type="text/javascript"></script>
